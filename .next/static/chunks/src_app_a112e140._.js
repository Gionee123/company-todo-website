...
"[project]/src/app/(admin-group)/admin-panel/dashboard/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Dashboard() {
    ...
    const fetchDashboardData = async ()=>{
        try {
            setLoading(true);
            // Fetch pending users
            const pendingUsersResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], "/api/backend/users/pending-users"));
            const pendingUsers = pendingUsersResponse.data || [];
            // Fetch all users (approved, rejected, pending)
            const allUsersResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], "/api/backend/users/all-actions"));
            ...
            recentUsers.forEach((user)=>{
                activities.push({
                    ...
                    message: "New user registered: ".concat(user.name),
            ...
            recentTodos.forEach((todo)=>{
                activities.push({
                    type: 'todo_completed',
                    message: "Todo completed: ".concat(todo.Todolist),
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            const handleStorage = {
                "Dashboard.useEffect.handleStorage": (e)=>{
                    if (e.key === 'admin_notification') {
                        const data = JSON.parse(e.newValue);
                        if (data && data.type === 'todo_completed') {
                            setNotification("User completed a todo: ".concat(data.todo.Todolist || data.todo.title));
                            setTimeout({
                                "Dashboard.useEffect.handleStorage": ()=>setNotification(null)
                            }["Dashboard.useEffect.handleStorage"], 5000);
                        }
                    }
                }
            }["Dashboard.useEffect.handleStorage"];
            window.addEventListener('storage', handleStorage);
            return ({
                "Dashboard.useEffect": ()=>window.removeEventListener('storage', handleStorage)
            })["Dashboard.useEffect"];
        }
    }["Dashboard.useEffect"], []);
    if (loading) {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            fileName: "[project]/src/app/(admin-group)/admin-panel/dashboard/page.js",
                            lineNumber: 128,
                            columnNumber: 13
                        }, this),
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                notification && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mb-4 p-4 bg-green-100 text-green-800 rounded shadow",
                            ...
                            children: recentActivities.map((activity, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "w-2 h-2 rounded-full ".concat(activity.status === 'approved' ? 'bg-green-500' : activity.status === 'pending' ? 'bg-yellow-500' : activity.status === 'rejected' ? 'bg-red-500' : 'bg-blue-500')
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(admin-group)/admin-panel/dashboard/page.js",
                                                    lineNumber: 195,
                                                    columnNumber: 21
...
_s(Dashboard, "pO+MES/4K4Afui6IQL1kG7j5/DU=");
_c = Dashboard;
var _c;
...
//# sourceMappingURL=src_app_a112e140._.js.map