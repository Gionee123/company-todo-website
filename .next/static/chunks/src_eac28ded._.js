...
function SignupPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            console.log('🔄 Attempting registration to:', "".concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], "/api/frontend/users/register"));
            console.log('📝 Form data:', {
                ...formData,
                password: '[HIDDEN]'
            });
            // API call for registration using axios - match the user's API structure
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], "/api/frontend/users/register"), {
                name: formData.name,
...
//# sourceMappingURL=src_eac28ded._.js.map